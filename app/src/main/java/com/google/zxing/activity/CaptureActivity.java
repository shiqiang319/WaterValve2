...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    public Result scanningImage(Uri uri) {
        ...
        com.google.zxing.decoding.RGBLuminanceSource source = new com.google.zxing.decoding.RGBLuminanceSource(scanBitmap);
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                boolean isSuccess = com.google.zxing.camera.CameraManager.get().setFlashLight(!isFlashOn);
                if(!isSuccess){
